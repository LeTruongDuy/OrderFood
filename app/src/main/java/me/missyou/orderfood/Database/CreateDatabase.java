package me.missyou.orderfood.Database;
...
public class CreateDatabase extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        String tbMONAN = "CREATE TABLE " + TB_MONAN + " ( " + TB_MONAN + " INTEGER PRIMARY KEY AUTOINCREMENT, "
        ...
        String tbGOIMON = "CREATE TABLE " + TB_GOIMON + " ( " + TB_GOIMON_MAGOIMON + " INTEGER PRIMARY KEY AUTOINCREMENT, "
                + TB_GOIMON_MANV + " INTEGER, " + TB_GOIMON_MABAN + " INTEGER, " + TB_GOIMON_NGAYGOI + " TEXT, "
                + TB_GOIMON_TINHTRANG + " TEXT )";

        String tbCHITIETGOIMON = "CREATE TABLE " + TB_CHITIETGOIMON + " ( " + TB_CHITIETGOIMON_MAMONAN + " TEXT, "
                + TB_CHITIETGOIMON_MAGOIMON + " INTEGER, " + TB_CHITIETGOIMON_SOLUONG + " INTEGER, "
